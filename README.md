TWO DISTANCES INTERSECTION in 2D - PLUGIN for QGIS APPLICATION

The plugin allows you get the intersection of two distances in two-dimensional Cartesian plane and is created with QGIS 3.28 application.
